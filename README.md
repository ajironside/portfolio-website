...
Notes:
	most sizes in em units - Would it be worth it to go back and transform into rem units?
	There is so much more css code than I thought there would be!
	I liked looking into the animations
	I am not sure what all of the .row css means 
